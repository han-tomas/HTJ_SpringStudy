	    ...
	    <table>
	    	...
	    	<tr>
	    		<td colspan="5" class="text-right">
	    			<button class="btn btn-sm btn-success">이전</button>
	    				{{curpage}} page/ {{totalpage}} pages
	    			<button class="btn btn-sm btn-success">다음</button>
	    		</td>
	    	</tr>
	    </table>
	 </div>
...
<script>
	new Vue({
		...
		methods:{
			...
			prev:function(){
				this.curpage=this.curpage>1?this.curpage-1:this.curapge
				this.dataRecv()
			},
			next:function(){
				this.curpage=this.curpage<this.totalpage?this.curpage+1:this.curapge
				this.dataRecv()
			}
		}
	})
