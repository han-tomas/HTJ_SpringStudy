...
<div class="wrapper row3">
  ...
  <h2 class="sectiontitle">맛집 상세보기</h2>
  	<div class="row">
  		<table class="table">
  			<tr>
  				<td class="text-center" v-for="img in posters">
  			...
  			<table class="table">
  				...
  				<tr>
  					<td colspan="2" class="text-right">
  						<a :href="'../food/food_detail.do?cno='+food_detail.cno" class="btn btn-xs btn-danger">목록</a>
  					</td>
  				</tr>
  			</table>
  					...
  					<td>	
  						<table class="table" v-for="rvo in reply_list">
  							...
  							<tr :id="'u'+rvo.no" class="updates" style="display:none">
			  					<td colspan="2">
			  						<textarea rows="5" cols="55" id="msg" style="float: left">{{rvo.msg}}</textarea>
			  						<button style="float: left;background-color: blue;color: white;width: 100px; height: 106px;" @click="replyUpdate(rvo.no)">댓글수정</button>
			  					</td>
			  				</tr>
  						</table>
  					</td>
  			...
  			<table class="table" v-if="sessionId!=''">
  				<tr>
  					<td>
  						...
  						<button style="float: left;background-color: blue;color: white;width: 100px; height: 106px;" @click="replyWrite()">댓글쓰기</button>
  					</td>
  				</tr>
  			</table>
  		</div>
