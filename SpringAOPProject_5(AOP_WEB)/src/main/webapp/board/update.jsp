...
<%-- 
	...
	클래스 등록(모든 클래스가 등록되는 것은 아니다) => 인터페이스, VO													
	XML
		<bean class="" id="">
		<context:componant-scan base-package="">
	어노테이션
		기능별 구분
		--------
		...
		*** 입사 (개발자)
			제일 먼저 하는것
			1)회사의 소스 분석
				우선순위 web.xml/server.xml/application.xml
