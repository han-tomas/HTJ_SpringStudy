...
public class MusicRestController {
	...
	public String music_list_vue(int cno)
	{
		String result="";
		try
		{
			...
			String[] titles= {"","Top 100","가요","POP","OST","트롯","JAZZ","CLASSIC"};
			int i=0;
			for(MusicVO vo:list)
			{
	...
	@GetMapping(value = "music/detail_vue.do",produces = "html/plain;charset=UTF-8")
